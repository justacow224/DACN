# ==============================================================================
# Regression Wrapper: tb_ml_kem_decaps
# ==============================================================================
# Usage (batch):
#   vivado -mode batch -source verilog_ML_KEM/scripts/sim/run_tb_ml_kem_decaps.tcl \
#     -tclargs <xpr_path> [max_kats] [kat_file]
#
# Usage (inside open Vivado project):
#   source verilog_ML_KEM/scripts/sim/run_tb_ml_kem_decaps.tcl
# ==============================================================================
...
if {[llength [get_projects -quiet]] == 0} {
    if {[llength $argv] < 1} {
        ...
        puts "Usage: vivado -mode batch -source run_tb_ml_kem_decaps.tcl -tclargs <xpr_path> [max_kats] [kat_file]"
        exit 1
    }
...
set_property top tb_ml_kem_decaps $fs
...
puts "PASS: tb_ml_kem_decaps regression passed (MAX_KATS=$max_kats, KAT_FILE=$kat_file_arg)"
if {$opened_here} { close_project }
exit 0
