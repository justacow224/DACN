# ==============================================================================
# Regression Wrapper: tb_ml_kem_top
# ==============================================================================
# Usage (batch):
#   vivado -mode batch -source verilog_ML_KEM/scripts/sim/run_tb_ml_kem_top.tcl \
#     -tclargs <xpr_path>
#
# Usage (inside open Vivado project):
#   source verilog_ML_KEM/scripts/sim/run_tb_ml_kem_top.tcl
# ==============================================================================
...
if {[llength [get_projects -quiet]] == 0} {
    if {[llength $argv] < 1} {
        ...
        puts "Usage: vivado -mode batch -source run_tb_ml_kem_top.tcl -tclargs <xpr_path>"
        exit 1
    }
...
puts "PASS: tb_ml_kem_top regression passed"
if {$opened_here} { close_project }
exit 0
