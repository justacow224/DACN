# Full one-shot flow: simulation gates -> synthesis -> implementation
# All output is isolated in keygen_metrics/full_flow_<ts>/
# Hardened against simulation hangs.
...
if {[llength $argv] < 1} {
    ...
    puts "Usage: vivado -mode batch -source keygen_full_flow.tcl -tclargs <xpr_path> [jobs]"
    exit 1
}
