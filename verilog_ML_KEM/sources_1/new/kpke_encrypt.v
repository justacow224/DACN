            ...
            case (state)
                ...
                S_NOISE_INIT: begin
                    if ((noise_stage == 2'd0) && (noise_idx == 2'd3)) begin
                        ...
                        // R-new-A Phase D2: lane squeeze for PRF (16 cyc/poly
                        // vs 128 cyc/poly byte). Saves ~1500 cyc/Encaps.
                        // Sponge fix in keccak_sponge_top defers init pulses
                        // that arrive while a permute is in flight, so this
                        // path is now silicon-clean.
