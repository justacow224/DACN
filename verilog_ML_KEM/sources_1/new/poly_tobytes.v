...
module poly_tobytes (
    ...
    localparam S_PACK  = 3'd3;  // Latch one coefficient pair
    ...
    reg [11:0] coeff0_latched;
    reg [11:0] coeff1_latched;
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            byte_addr      <= 9'd0;
            byte_dout      <= 8'd0;
            coeff0_latched <= 12'd0;
            coeff1_latched <= 12'd0;
            wr_cnt         <= 2'd0;
        end else begin
            byte_we <= 1'b0;
            ...
            case (state)
                ...
                S_PACK: begin
                    coeff0_latched <= coeff_a0[11:0];
                    coeff1_latched <= coeff_a1[11:0];
                    wr_cnt         <= 2'd0;
                    state          <= S_WRITE;
                end
                ...
                S_WRITE: begin
                    ...
                    case (wr_cnt)
                        2'd0:    byte_dout <= coeff0_latched[7:0];
                        2'd1:    byte_dout <= {coeff1_latched[3:0], coeff0_latched[11:8]};
                        default: byte_dout <= coeff1_latched[11:4];
                    endcase
